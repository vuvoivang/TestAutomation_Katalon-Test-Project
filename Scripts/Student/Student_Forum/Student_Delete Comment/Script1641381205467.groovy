...
WebUI.click(findTestObject('Object Repository/Page_OOP Tho lun  thi cui k 2019-2020/a_Delete'))

WebUI.click(findTestObject('Object Repository/Page_OOP/button_Continue'))
