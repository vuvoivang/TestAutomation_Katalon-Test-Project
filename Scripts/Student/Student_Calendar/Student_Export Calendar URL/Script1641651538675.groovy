...
WebUI.click(findTestObject('Object Repository/Page_Moodle Calendar Export/input_This month_periodtimeperiod'))

WebUI.click(findTestObject('Object Repository/Page_Moodle Calendar Export/input_Custom range (30122 - 80123)_generateurl'))
