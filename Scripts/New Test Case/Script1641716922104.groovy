...
WebUI.click(findTestObject('Object Repository/Page_Course Ton t hp/img_Information about the Page activity_icon icon'))

WebUI.click(findTestObject('Object Repository/Page_Editing Quiz/input_Name_name'))

WebUI.setText(findTestObject('Object Repository/Page_Editing Quiz/input_Name_name'), 'test test')
