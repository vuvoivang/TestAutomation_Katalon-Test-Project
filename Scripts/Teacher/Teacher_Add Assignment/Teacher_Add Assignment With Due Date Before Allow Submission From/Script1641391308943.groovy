...
WebUI.setText(findTestObject('Object Repository/Page_Editing Assignment/input_Assignment name_name'), 'Assigment With Due Date Before Allow Submission From')
