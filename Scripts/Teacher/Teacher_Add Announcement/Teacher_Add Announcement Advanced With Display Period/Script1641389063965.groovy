...
WebUI.setText(findTestObject('Object Repository/Page_Announcements/input_Subject_subject'), 'Topic Advance Display Period')

WebUI.setText(findTestObject('Object Repository/Page_Announcements/div_This is a topic with advance display pe_a06968'), 
    'This is a topic with advance display period field')

WebUI.click(findTestObject('Object Repository/Page_Announcements/input_Cancel_advancedadddiscussion'))

WebUI.click(findTestObject('Object Repository/Page_TTH Add a new topic/a_Display period_1'))

WebUI.click(findTestObject('Object Repository/Page_TTH Add a new topic/input_Enable_timestartenabled'))
