...
WebUI.setText(findTestObject('Object Repository/Page_Announcements/input_Subject_subject'), 'Basic Topic')

WebUI.setText(findTestObject('Object Repository/Page_Announcements/div_This is a basic topic with all required field'), 
    'This is a basic topic with all required field')
